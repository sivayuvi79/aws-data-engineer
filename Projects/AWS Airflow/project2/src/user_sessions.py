...
with DAG(
    ...
    def get_new_users(**context):
        ...
        response = requests.get(
            f"http://54.205.243.215:8000/users?start_date={start_date}&end_date={end_date}"
        )
        ### END CODE HERE ###
    ...
    def get_session(**context):
        ...
        # APIEndpoint to fill the `<API_ENDPOINT>` placeholder.
        response = requests.get(
            f"http://54.205.243.215:8000/platform_sessions?start_date={start_date}&end_date={end_date}"
        )
        ### END CODE HERE ###
    ...
    def get_session_info_dict(date: str):
        ...
        session_info_string = get_object["Body"].read()
        ### END CODE HERE ###
    ...
    def get_user_info(**context):
        ...
        for session in session_info:
            ...
            response = requests.get(
                f"http://54.205.243.215:8000>/users_by_id?user_ids={user_id}"
            )
